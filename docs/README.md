...
This directory is for source-kit documentation. Generated target-state docs live in `templates/docs/` and render into `.diffmogger/state/`.

## Active Docs

- [Fresh Project Setup](FRESH_PROJECT_SETUP.md): dashboard and CLI setup flow for fresh or existing target repos.
- [Dashboard](DASHBOARD.md): native dashboard, backend CLI, scheduling, safety, review, and worker controls.
