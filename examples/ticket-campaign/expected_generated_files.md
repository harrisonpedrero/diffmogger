...
The generated prompt and task file should not use product-roadmap language such as `MVP`, `Beyond MVP`, or `Ambitious extensions`. `docs/TICKET_RUN.md` is the source of truth for scope, optional `depends_on` arrays order dependent tickets, and automation should stop launching new work after all tickets are done or blocked.
