#!/usr/bin/env python3
"""Compatibility wrapper for diffmogger.runtime.preflight."""
...
if __name__ != "__main__":
    from diffmogger.runtime.preflight import *  # noqa: F401,F403,E402


def _main() -> int:
    runpy.run_module("diffmogger.runtime.preflight", run_name="__main__")
    return 0
