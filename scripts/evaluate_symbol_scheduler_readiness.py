#!/usr/bin/env python3
"""Compatibility wrapper for diffmogger.runtime.readiness_eval."""
...
if __name__ != "__main__":
    from diffmogger.runtime.readiness_eval import *  # noqa: F401,F403,E402


def _main() -> int:
    runpy.run_module("diffmogger.runtime.readiness_eval", run_name="__main__")
    return 0
