#!/usr/bin/env python3
"""Compatibility wrapper for diffmogger.runtime.run_observatory."""
...
if __name__ != "__main__":
    from diffmogger.runtime.run_observatory import *  # noqa: F401,F403,E402


def _main() -> int:
    runpy.run_module("diffmogger.runtime.run_observatory", run_name="__main__")
    return 0
