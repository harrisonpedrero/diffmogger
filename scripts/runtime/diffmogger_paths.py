#!/usr/bin/env python3
"""Compatibility wrapper for diffmogger.runtime.paths."""
...
if __name__ != "__main__":
    from diffmogger.runtime.paths import *  # noqa: F401,F403,E402


def _main() -> int:
    runpy.run_module("diffmogger.runtime.paths", run_name="__main__")
    return 0
