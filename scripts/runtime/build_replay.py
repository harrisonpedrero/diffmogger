#!/usr/bin/env python3
"""Compatibility wrapper for diffmogger.runtime.build_replay."""
...
if __name__ != "__main__":
    from diffmogger.runtime.build_replay import *  # noqa: F401,F403,E402


def _main() -> int:
    runpy.run_module("diffmogger.runtime.build_replay", run_name="__main__")
    return 0
