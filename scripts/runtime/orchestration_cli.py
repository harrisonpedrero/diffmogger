#!/usr/bin/env python3
"""Compatibility wrapper for diffmogger.orchestration.cli."""
...
if __name__ != "__main__":
    from diffmogger.orchestration.cli import *  # noqa: F401,F403,E402


def _main() -> int:
    runpy.run_module("diffmogger.orchestration.cli", run_name="__main__")
    return 0
