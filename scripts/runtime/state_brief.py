#!/usr/bin/env python3
"""Compatibility wrapper for diffmogger.runtime.state_brief."""
...
if __name__ != "__main__":
    from diffmogger.runtime.state_brief import *  # noqa: F401,F403,E402


def _main() -> int:
    runpy.run_module("diffmogger.runtime.state_brief", run_name="__main__")
    return 0
