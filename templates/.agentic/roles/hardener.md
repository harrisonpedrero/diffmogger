...
- When hardening data-source work, verify that fixture, mock, synthetic, cached, imported, and live states are distinguishable; real-data claims must have connector/cache/provenance evidence or explicit deferred-live work.
