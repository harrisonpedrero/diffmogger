...
- Use read-only worker reports by default. Use write-capable workers only when explicitly enabled, the change is large and planned, ownership is disjoint, and the main agent will integrate and verify.
