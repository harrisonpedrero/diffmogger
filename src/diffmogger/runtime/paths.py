...
PATH_ALIASES: dict[str, str] = {
    ...
    ".agentic/design_contract.json": ".diffmogger/agentic/design_contract.json",
    ".agentic/design_contract.md": ".diffmogger/agentic/design_contract.md",
    ...
    ".agentic/roles/designer.md": ".diffmogger/agentic/roles/designer.md",
    ...
    "target/design_contract.json": ".diffmogger/runtime/design_contract.json",
    "target/design_reviews": ".diffmogger/runtime/design_reviews",
