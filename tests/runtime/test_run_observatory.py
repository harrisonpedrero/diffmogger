...
OBSERVATORY_WRAPPER_PATHS = [
    ROOT / "scripts" / "runtime" / "run_observatory.py",
]
...
class ObservatorySnapshotTests(unittest.TestCase):
    ...
    def test_source_observatory_script_is_runtime_wrapper(self) -> None:
        for path in OBSERVATORY_WRAPPER_PATHS:
            text = path.read_text(encoding="utf-8")
            self.assertIn("diffmogger.runtime.run_observatory", text)
    ...
    def seed_target(self, root: Path) -> None:
        ...
        self.write_json(
            ...
            "target/automation_runner.json",
            {
                ...
                "state": "running",
                "pid": 12345,
                "started_at": "2026-05-03T22:30:00+00:00",
            },
        )
        self.write_json(
            root,
    ...
    def seed_priority_target(self, root: Path, *, include_deferred_pressure: bool) -> None:
        ...
        self.write_json(
            ...
            "target/automation_runner.json",
            {
                ...
                "state": "running",
                "pid": 12345,
                "started_at": "2026-05-03T22:50:00+00:00",
            },
        )
        self.write_json(
            root,
